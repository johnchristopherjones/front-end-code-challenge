...
import { getSelectedLocationId, getSelectedLocation, getLocationIsLoading } from 'src/app/reducers/location.reducer';
...
export class LocationDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.isLoading$ = this.store.pipe(select(getLocationIsLoading));
  }
